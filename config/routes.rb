Rails.application.routes.draw do
  root 'beers#index'
  # get 'user_beers/show' => 'user_beers#show'
  # get 'user_beers' => 'user_beers#show'
  ...
  resources :user_beers, only: [:edit, :update, :destroy, :index]
  ...
  post 'user_beers/search' => 'user_beers#search'
